...
locals {
  ...
  app_user_privileges = var.app_user_privileges != null ? var.app_user_privileges : ["ALL PRIVILEGES"]
  admin_privileges    = var.admin_privileges != null ? var.admin_privileges : ["ALL PRIVILEGES"]
